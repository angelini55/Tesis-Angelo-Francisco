...
#unidades
        ...
        self.txt1 = Entry(self, state="disabled")
        self.txt2 = Entry(self, state="disabled")
        self.txt3 = Entry(self, state="disabled")
        self.txt4 = Entry(self, state="disabled")
        self.txt5 = Entry(self, state="disabled")
        self.txt6 = Entry(self, state="disabled")
        self.txt7 = Entry(self, state="disabled")
        self.txt8 = Entry(self, state="disabled")
        self.txt9 = Entry(self, state="disabled")
        self.txt10 = Entry(self, state="disabled")
        self.txt11 = Entry(self, state="disabled")
        self.txt12 = Entry(self, state="disabled")
        self.txt13 = Entry(self, state="disabled")
        self.txt14 = Entry(self, state="disabled")
        self.txt15 = Entry(self, state="disabled")
        self.txt16 = Entry(self, state="disabled")
        self.txt18 = Entry(self, state="disabled")
        self.entries_list = [self.txt1, self.txt2, self.txt3, self.txt4, self.txt5, self.txt6, self.txt7, self.txt8, self.txt9, self.txt10, self.txt11, self.txt12, self.txt13, self.txt14, self.txt15, self.txt16, self.txt18]
...
#ubicar widget
        self.lbl1.place(x=10, y=100, width=50, height=20)
        self.lbl2.place(x=10, y=130, width=50, height=20)
        self.lbl3.place(x=10, y=160, width=50, height=20)
        self.lbl4.place(x=10, y=190, width=50, height=20)
        self.lbl5.place(x=10, y=220, width=50, height=20)
        self.lbl6.place(x=10, y=250, width=50, height=20)
        self.lbl7.place(x=10, y=280, width=50, height=20)
        self.lbl8.place(x=10, y=310, width=50, height=20)
        self.lbl9.place(x=10, y=340, width=50, height=20)
        self.lbl10.place(x=10, y=370, width=50, height=20)
        self.lbl11.place(x=10, y=400, width=50, height=20)
        ...
        self.lbl17.place(x=330, y=10, width=350, height=350)
        self.lbl18.place(x=190, y=510, width=40, height=20)

        self.lbl20.place(x=150, y=100, width=50, height=20)
        self.lbl22.place(x=150, y=160, width=50, height=20)
        self.lbl23.place(x=150, y=190, width=50, height=20)
        self.lbl24.place(x=150, y=220, width=50, height=20)
        self.lbl25.place(x=150, y=250, width=50, height=20)
        self.lbl26.place(x=150, y=280, width=50, height=20)
        self.lbl27.place(x=150, y=310, width=50, height=20)
        self.lbl28.place(x=150, y=340, width=50, height=20)
        self.lbl29.place(x=150, y=370, width=50, height=20)
        self.lbl30.place(x=150, y=400, width=50, height=20)
        ...
        self.txt1.place(x=70, y=100, width=80, height=20)
        self.txt2.place(x=70, y=130, width=80, height=20)
        self.txt3.place(x=70, y=160, width=80, height=20)
        self.txt4.place(x=70, y=190, width=80, height=20)
        self.txt5.place(x=70, y=220, width=80, height=20)
        self.txt6.place(x=70, y=250, width=80, height=20)
        self.txt7.place(x=70, y=280, width=80, height=20)
        self.txt8.place(x=70, y=310, width=80, height=20)
        self.txt9.place(x=70, y=340, width=80, height=20)
        self.txt10.place(x=70, y=370, width=80, height=20)
        self.txt11.place(x=70, y=400, width=80, height=20)
        ...
        self.btn2.place(x=200, y=170, width=40, height=40)
