...
class Seleccion(Frame):
    ...
    def create_widget(self):
        ...
        self.btn3 = Button(self, text="Frenos y embragues de banda",height=5, command=menu3)
        self.btn4 = Button(self, text="Frenos y embragues de disco",height=5, command=menu4)
