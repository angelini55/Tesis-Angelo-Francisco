...
de referencia que coincide con el pasador"""
    ...
    def menu1(self):
        ...
        self.active_window.title("Cálculos de diseño para frenos y embragues de zapata interna")
    ...
    def menu2(self):
        ...
        self.active_window.resizable(0,0)
        self.active_window.title("Cálculos de diseño para frenos y embragues de zapata externa")
        self.active_window.update()
        w = self.active_window.winfo_width()
        h = self.active_window.winfo_height()
        ws = self.active_window.winfo_screenwidth()
    ...
    def menu2_5(self):
        ...
        self.active_window.resizable(0,0)
        self.active_window.title("Cálculos de diseño para frenos y embragues de zapata externa simetrica")
        self.active_window.update()
        w = self.active_window.winfo_width()
        h = self.active_window.winfo_height()
        ws = self.active_window.winfo_screenwidth()
    ...
    def menu3(self):
        ...
        self.active_window.resizable(0,0)
        self.active_window.title("Cálculos de diseño para frenos y embragues de banda")
        self.active_window.update()
        w = self.active_window.winfo_width()
        h = self.active_window.winfo_height()
        ws = self.active_window.winfo_screenwidth()
    ...
    def menu4(self):
        ...
        self.active_window.resizable(0,0)
        self.active_window.title("Cálculos de diseño para frenos y embragues de disco")
        self.active_window.update()
        w = self.active_window.winfo_width()
        h = self.active_window.winfo_height()
        ws = self.active_window.winfo_screenwidth()
    ...
    def menu5(self):
        ...
        self.active_window.resizable(0,0)
        self.active_window.title("Cálculos de diseño para frenos y embragues de mordaza con zapata anular")
        self.active_window.update()
        w = self.active_window.winfo_width()
        h = self.active_window.winfo_height()
        ws = self.active_window.winfo_screenwidth()
    ...
    def menu6(self):
        ...
        self.active_window.resizable(0,0)
        self.active_window.title("Cálculos de diseño para frenos y embragues de mordaza con zapata circular")
        self.active_window.update()
        w = self.active_window.winfo_width()
        h = self.active_window.winfo_height()
        ws = self.active_window.winfo_screenwidth()
    ...
    def menu7(self):
        ...
        self.active_window.resizable(0,0)
        self.active_window.title("Cálculos de diseño para frenos y embragues conicos")
        self.active_window.update()
        w = self.active_window.winfo_width()
        h = self.active_window.winfo_height()
        ws = self.active_window.winfo_screenwidth()
