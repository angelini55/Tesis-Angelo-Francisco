...
que coincide con el pasador"""
    ...
    def create_widget(self):
        ...
        self.labels = []
        textoslbl = ["Padm: Presión máxima admisible ejercida en la banda o el tambor","D: Diámetro externo del tambor","b: Ancho de la banda",
        "µ: Coeficiente de fricción dinámico entre la banda y el tambor","Ø: Ángulo de contacto entre la banda y el tambor"]
        ...
        self.image_filename = resource_path('images\\Freno Banda.png')
        ...
        self.boton1.place(x=400, y=400, width=70, height=50)
