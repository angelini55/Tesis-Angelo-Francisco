...
class FrenoConicoWindow_diseño(Frame):
    ...
    def vent_temp(self):
        ...
        Dint = float(self.textos2[1].get())/2
        ...
        if self.list2.get() == "Sistema Internacional":
            vent.textos2[0].insert(0,Dext/1000)
            vent.textos2[1].insert(0,Dint/1000)
        else:
    ...
    def create_widget(self):
        ...
        self.labels2 = []
        textoslabels2 = ["D: Diámetro externo del cono de fricción","d: Diámetro interno del cono de fricción",
        "α: Ángulo del cono"]
        ...
        self.image_filename = resource_path('images\\Freno conico diseño.png')
...
if __name__ == "__main__":
    ...
    FrenoConicoWindow_diseño(root).mainloop()