...
class FrenoZapataAnularWindow_diseño(Frame):
    ...
    def guardar_calc(self):
        ...
        ro = float(self.textos2[1].get())
        Θ1 = float(self.textos2[2].get())
        Θ2 = float(self.textos2[3].get())

        rprima = self.textos3[0].get()
        F = self.textos3[1].get()
        FD = self.textos3[2].get()
        T = self.textos3[4].get()
        self.contenido = "ri: {} \nro:{} \nΘ1: {} \nΘ2: {} \nr': {} \nF: {}\nFD: {} \nT: {}".format(ri,ro,Θ1,Θ2,rprima,F,FD,T)
    ...
    def calc_diseño(self):
        try:
            ...
            self.textos3[0].insert(0,rprima)
    ...
    def create_widget(self):
        ...
        self.image_filename = resource_path('images\\Freno zapata anular diseño.png')
        ...
        self.labels2 = []
        textoslabels2 = ["ri: Radio interno de la zapata anular","ro: Radio externo de la zapata anular",
        "Θ1: Ángulo inicial del material de fricción","Θ2: Ángulo final del material de fricción"]
        ...
        self.labels3 = []
        textoslabels3 = ["r': Ubicación de la línea de acción de la fuerza de accionamiento","F: Fuerza de accionamiento","Factor de diseño",
...
if __name__ == "__main__":
    ...
    FrenoZapataAnularWindow_diseño(root).mainloop()