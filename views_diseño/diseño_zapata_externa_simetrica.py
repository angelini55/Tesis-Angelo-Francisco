...
class ZapataExternaSimetricaWindow_diseño(Frame):
    ...
    def guardar_calc(self):
        r = float(self.textos2[0].get())
        b = float(self.textos2[1].get())
        Θ2 = float(self.textos2[2].get())

        a = self.textos3[0].get()
        F = self.textos3[1].get()
        FD = self.textos3[2].get()
        T = self.textos3[4].get()
        self.contenido = "r: {} \nb:{} \nΘ2: {} \na: {} \nF: {}\nFD: {} \nT: {}".format(r,b,Θ2,a,F,FD,T)
    ...
    def vent_temp(self):
        ...
        Dext = float(self.textos2[0].get())*2
    ...
    def ventana_analisis(self):
        new_window = ZapataESimetricaWindow(Toplevel())
    ...
    def create_widget(self):
        ...
        Internacional = ["rpm","N","","","horas","kg.m^2/s","N.mm","m/s","mm","mm","°","mm","N","","MPa","N.mm"]
        Ingles = ["rpm","lb","","","horas","lb.ft^2/s","lb.in","ft/min","in","in","°","in","lb","","PSI","lb.in"]
        ...
        self.labels2 = []
        textoslabels2 = ["r: Radio externo del tambor","b: Ancho de la zapata","Θ2: Ángulo final material de fricción"]
        ...
        self.labels3 = []
        textoslabels3 = ["a: Distancia desde el pivote hasta el centro del tambor","F: Fuerza de accionamiento","Factor de diseño",
...
if __name__ == "__main__":
    ...
    ZapataExternaSimetricaWindow_diseño(root).mainloop()